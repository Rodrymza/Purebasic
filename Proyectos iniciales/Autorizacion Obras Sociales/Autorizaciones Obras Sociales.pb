...
Procedure guardar_base_datos(List lista.info())
  ...
  ForEach lista()
    WriteStringN(#archivo_bdd, lista()\nombre + ", " + Str(lista()\autorizacion) + ", " + Str(lista()\coseguro) + ", " + lista()\requisito_especial)
  Next
...
AddGadgetColumn(#lista_obras_sociales, 3, "Requisito especial", 150)
    ...
    Case #PB_Event_Gadget
      Select EventGadget()
        ...
        Case #boton_modificar
          If buscar_elemento(GetGadgetText(#lista_obras_sociales), obras_sociales())
